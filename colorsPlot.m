...
% Create subplot
subplot1 = subplot(2,2,1,'Parent',figure3,'YDir','reverse','Layer','top');
...
% Create subplot
subplot2 = subplot(2,2,2,'Parent',figure3,'YDir','reverse','Layer','top');
% Uncomment the following line to preserve the X-limits of the axes
 xlim([0.5 320.5]);
% Uncomment the following line to preserve the Y-limits of the axes
 ylim([0.5 240.5]);
...
% Create subplot
subplot3 = subplot(2,2,3,'Parent',figure3,'YDir','reverse','Layer','top');
% Uncomment the following line to preserve the X-limits of the axes
 xlim([0.5 320.5]);
% Uncomment the following line to preserve the Y-limits of the axes
 ylim([0.5 240.5]);
...
% Create subplot
subplot4 = subplot(2,2,4,'Parent',figure3,'YDir','reverse','Layer','top');
% Uncomment the following line to preserve the X-limits of the axes
 xlim([0.5 320.5]);
% Uncomment the following line to preserve the Y-limits of the axes
 ylim([0.5 240.5]);
